...
import { MoveLeft, ShieldCheck, Loader2Icon } from "lucide-react";
...
export default function LoginPage() {
  ...
  return sess || isPending ? (
    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center p-6 md:p-10 bg-[#050505] overflow-hidden text-white">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          <motion.div
            ...
            className="size-16 bg-white rounded-2xl flex items-center justify-center shadow-2xl shadow-primary/20"
          >
            *
            <Image
      ...
      {/* --- SIGNATURE --- */}
      <footer className="text-[10px] uppercase tracking-[0.2em] text-gray-400 mt-8">
        YambiPass System •{" "}
        <Link
